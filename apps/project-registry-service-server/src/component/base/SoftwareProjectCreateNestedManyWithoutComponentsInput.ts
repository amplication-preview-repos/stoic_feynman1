...
@InputType()
class SoftwareProjectCreateNestedManyWithoutComponentsInput {
...
export { SoftwareProjectCreateNestedManyWithoutComponentsInput as SoftwareProjectCreateNestedManyWithoutComponentsInput };
