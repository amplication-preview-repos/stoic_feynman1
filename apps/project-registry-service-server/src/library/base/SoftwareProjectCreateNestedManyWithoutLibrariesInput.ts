...
@InputType()
class SoftwareProjectCreateNestedManyWithoutLibrariesInput {
...
export { SoftwareProjectCreateNestedManyWithoutLibrariesInput as SoftwareProjectCreateNestedManyWithoutLibrariesInput };
