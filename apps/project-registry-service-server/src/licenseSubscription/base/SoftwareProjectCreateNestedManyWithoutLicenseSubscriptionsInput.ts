...
@InputType()
class SoftwareProjectCreateNestedManyWithoutLicenseSubscriptionsInput {
...
export { SoftwareProjectCreateNestedManyWithoutLicenseSubscriptionsInput as SoftwareProjectCreateNestedManyWithoutLicenseSubscriptionsInput };
