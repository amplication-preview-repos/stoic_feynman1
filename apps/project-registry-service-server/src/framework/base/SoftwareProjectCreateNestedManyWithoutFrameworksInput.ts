...
@InputType()
class SoftwareProjectCreateNestedManyWithoutFrameworksInput {
...
export { SoftwareProjectCreateNestedManyWithoutFrameworksInput as SoftwareProjectCreateNestedManyWithoutFrameworksInput };
