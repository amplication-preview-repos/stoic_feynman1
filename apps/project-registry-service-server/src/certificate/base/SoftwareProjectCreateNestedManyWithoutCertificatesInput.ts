...
@InputType()
class SoftwareProjectCreateNestedManyWithoutCertificatesInput {
...
export { SoftwareProjectCreateNestedManyWithoutCertificatesInput as SoftwareProjectCreateNestedManyWithoutCertificatesInput };
